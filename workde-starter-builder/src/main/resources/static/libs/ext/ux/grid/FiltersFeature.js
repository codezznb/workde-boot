 ...
 *
 * Columns that are filtered have {@link #filterCls a configurable styles class} applied to the column headers.
 *
...
Ext.define('Ext.ux.grid.FiltersFeature', {
     ...
     * The styles class to be applied to column headers with active filters.
