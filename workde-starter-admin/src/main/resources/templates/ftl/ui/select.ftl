...
<#macro select
list value="" multiple="" headerKey="" headerValue="" listKey="" listValue="" listDeep="" label=""
noHeight="false" required="false" colspan="" width="" help="" helpPosition="2" colon=":" hasColon="true"
