...
public class IndexController extends WorkdeController {
	...
	public ModelAndView index() {
		return new ModelAndView("cpanel/index.html");
	}

	@GetMapping(value = "top", produces = MediaType.TEXT_HTML_VALUE)
	public ModelAndView menu() {
		ModelAndView mv = new ModelAndView("cpanel/top.html");
	...
	public ModelAndView left(String group_id) {
		ModelAndView mv = new ModelAndView("cpanel/left.html");
		...
		if(StringUtils.isNotEmpty(group_id)) {
			for(MenuGroup group : menuGroupList) {
				log.info("group -> {} {}", group, group.getId().equals(group_id));
	...
	public ModelAndView main() {
		return new ModelAndView("cpanel/main.html");
	}
}
